...
class Style:
    ...
    def __init__(self):
        ...
        self.secondary_color = "#4169E1"    # Royal blue
        self.accent_color = "#DC143C"       # Crimson
        
        # Outcome colors (commonly used in behavioral analysis)
        self.outcome_colors = {
            "correct": "#2E8B57",    # Green
            "incorrect": "#DC143C",  # Red
            "timeout": "#FF8C00",    # Orange
            "reward": "#4169E1",     # Blue
            "omission": "#8A2BE2"    # Purple
        }
        
        # Color palette for multiple categories
        self.color_palette = [
            "#2E8B57", "#4169E1", "#DC143C", "#FF8C00", "#8A2BE2",
            "#00CED1", "#FF69B4", "#32CD32", "#FFD700", "#FF6347"
        ]
    ...
    def get_outcome_color(self, outcome: str) -> str:
        """Get color for a specific outcome.
        
        Args:
            outcome: Outcome name (e.g., "correct", "incorrect")
            
        Returns:
            Color string for the outcome
        """
        return self.outcome_colors.get(outcome, self.primary_color)
    ...
    def __repr__(self):
        return f"Style(font_size={self.font_size}, primary_color='{self.primary_color}')"
...
def get_outcome_color(outcome: str) -> str:
    """Get default color for an outcome.
    ...
    Returns:
        Color string
    """
    return Style().get_outcome_color(outcome)
